...
const OracleLogo = () => (
  <svg height="28" viewBox="0 0 160 30" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M22.5 0H7.5C3.36 0 0 3.36 0 7.5V22.5C0 26.64 3.36 30 7.5 30H22.5C26.64 30 30 26.64 30 22.5V7.5C30 3.36 26.64 0 22.5 0ZM22.5 22.5H7.5V7.5H22.5V22.5Z" fill="#EA2A2A"/>
    <text x="36" y="22" fontFamily="Plus Jakarta Sans, sans-serif" fontWeight="800" fontSize="22" fill="#EA2A2A" letterSpacing="1">ORACLE</text>
  </svg>
);

const MetaLogo = () => (
  <svg height="28" viewBox="0 0 140 30" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M18.8 3.5C13.2 3.5 8.9 7.4 5.9 11.7C3.9 14.6 2.3 17.8 0 20.3C1.8 23.2 4.4 25.5 7.6 26.3C11.5 27.2 15.6 26.2 18.8 23.9C21.7 21.8 24.2 18.9 26.7 16.1C27.5 15.2 28.5 14.1 29.5 14.1C30.6 14.1 31.6 15.2 32.4 16.1C34.9 18.9 37.4 21.8 40.3 23.9C43.5 26.2 47.6 27.2 51.5 26.3C54.7 25.5 57.3 23.2 59.1 20.3C56.8 17.8 55.2 14.6 53.2 11.7C50.2 7.4 45.9 3.5 40.3 3.5C35.9 3.5 32.2 6.1 29.5 9.7C26.8 6.1 23.1 3.5 18.8 3.5Z" fill="#0668E1"/>
    <text x="56" y="22" fontFamily="Plus Jakarta Sans, sans-serif" fontWeight="800" fontSize="22" fill="#000000">Meta</text>
  </svg>
);

const MicrosoftLogo = () => (
  <svg height="26" viewBox="0 0 160 30" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="36" y="21" fontFamily="Plus Jakarta Sans, sans-serif" fontWeight="700" fontSize="20" fill="#737373">Microsoft</text>
  </svg>
);

const IBMLogo = () => (
  <svg height="26" viewBox="0 0 100 30" fill="none" xmlns="http://www.w3.org/2000/svg">
    <text x="0" y="22" fontFamily="Plus Jakarta Sans, sans-serif" fontWeight="800" fontSize="24" fill="#0F62FE" letterSpacing="2">IBM</text>
  </svg>
);
